              ...
              >
                ...
                <div className="text-center">
                  ...
                  {download.hasDropdown ? (
                    <div ref={macControlRef} className="relative w-full isolate">
                      ...
                      {macMenuOpen && (
                        <div className="absolute top-full left-0 right-0 mt-2 bg-gray-800 rounded-xl border-2 border-gray-500 shadow-2xl z-[999999]">
                          <button
                            type="button"
                            onClick={(e) => { 
                              e.preventDefault();
